...
<body>
  ...
  <div class="container">
    ...
    <div class="panel panel-primary">
      ...
      <?php
      $result = $koneksi->query("select * from kriteria where id_kriteria = " . $_GET['id'] . "");
      if (!$result) {
          ...
          <form role="form" method="post" action="edit-k.php?id=<?php echo $_GET['id']; ?>">
            <div class="box-body">
              ...
              <div class="form-group">
							...
							<input type="text" class="form-control" name="kepentingan" id="kepentingan" placeholder="Nilai Kepentingan">
						</div>
              </div>
              <div class="form-group">
